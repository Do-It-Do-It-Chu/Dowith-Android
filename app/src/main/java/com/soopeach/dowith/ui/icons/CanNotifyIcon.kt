...
val CanNotifyIcon: ImageVector
    get() {
        if (_canNotifyIcon != null) {
            return requireNotNull(_canNotifyIcon)
        }
        _canNotifyIcon = Builder(name = "CanNotifyIcon", defaultWidth = 28.0.dp, defaultHeight =
                28.0.dp, viewportWidth = 28.0f, viewportHeight = 28.0f).apply {
            path(fill = SolidColor(Color(0xFFFF9933)), stroke = null, strokeLineWidth = 0.0f,
...
private var _canNotifyIcon: ImageVector? = null
